...
source("LAG_ADJACENT.R", local = TRUE, chdir = TRUE)

one_state<-list(list_of_states[['Alabama']])

single_state_example4 <- mclapply(one_state, ES_ADJACENT, auto=TRUE, n_weeks_ahead=1,list_of_states=list_of_states, week_lag=1, mc.cores=1)
